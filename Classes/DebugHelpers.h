...
#define DEBUG_PRINT_OP(e) DEBUG_INDENTATION DEBUG_PRINT("OPERATION: " + e->toString() + '\n');
#define DEBUG_PRINT_RS(e) DEBUG_INDENT_DECR DEBUG_INDENTATION DEBUG_PRINT("RES: "+e->toString()+'\n');
#define DEBUG_PRINT_LT(e) DEBUG_INDENTATION                   DEBUG_PRINT("FST: "+e->toString()+'\n');DEBUG_INDENT_INCR
#define DEBUG_PRINT_EV(e) DEBUG_INDENT_DECR DEBUG_INDENTATION DEBUG_PRINT("EVL: "+e->toString()+'\n');DEBUG_INDENT_INCR
#define DEBUG_PRINT_RT(e) DEBUG_INDENT_DECR DEBUG_INDENTATION DEBUG_PRINT("SND: "+e->toString()+'\n');DEBUG_INDENT_INCR
