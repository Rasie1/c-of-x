...
BOOST_AUTO_TEST_CASE(assignment)
{
    ...
    BOOST_CHECK_EQUAL(cast<Integer>(x)->value, 0);
}
...
BOOST_AUTO_TEST_CASE(identityFunction)
{
    ...
    BOOST_CHECK_EQUAL(cast<Integer>(applied0)->value, 5);
}
...
BOOST_AUTO_TEST_CASE(indirection)
{
    ...
    BOOST_CHECK_EQUAL(cast<Integer>(result)->value, 5);
}
...
BOOST_AUTO_TEST_CASE(twoArgumentFunction)
{
    ...
    BOOST_CHECK_EQUAL(cast<Integer>(applied)->value, 3);
}
...
BOOST_AUTO_TEST_CASE(typedArgument)
{
    ...
    BOOST_CHECK_EQUAL(cast<Integer>(applied)->value, 1);
}
...
BOOST_AUTO_TEST_CASE(then)
{
    ...
    BOOST_REQUIRE(checkType<Integer>(x));
    BOOST_CHECK_EQUAL(cast<Integer>(x)->value, 1);
...
//    BOOST_CHECK(cast<Operation>(x)->value == 100);
...
BOOST_AUTO_TEST_CASE(moreThan)
{
    ...
    auto x = env.getEqual("x")->eval(env);
    BOOST_CHECK_EQUAL(cast<Integer>(x)->value, 100);
...
BOOST_AUTO_TEST_CASE(substitutionInPartialApplication)
{
    ...
    auto x = env.getEqual("x")->eval(env);
    BOOST_REQUIRE(checkType<Integer>(x));
    BOOST_CHECK_EQUAL(cast<Integer>(x)->value, 4);
}
...
BOOST_AUTO_TEST_CASE(unapplyPlus)
{
    ...
    auto x = env.getEqual("x");
    BOOST_REQUIRE(checkType<Integer>(x));
    BOOST_CHECK_EQUAL(cast<Integer>(x)->value, -2);
}
...
BOOST_AUTO_TEST_CASE(reverseApplication)
{
    ...
    parsed->eval(env);
    auto x = env.getEqual("x");
    BOOST_CHECK_EQUAL(cast<Integer>(x)->value, 9);
}
...
BOOST_AUTO_TEST_CASE(simpleMacroMatch)
{
    ...
    BOOST_CHECK_EQUAL(cast<Integer>(c)->value, 4);
...
//     auto c = parsed->eval(env);
//     BOOST_CHECK_EQUAL(cast<Integer>(c)->value, 0);
...
//     auto c = parsed->eval(env);
//     BOOST_CHECK_EQUAL(cast<Identifier>(c)->name, "identity");
// }
...
//     auto c = parsed->eval(env);
//     BOOST_CHECK_EQUAL(cast<Integer>(c)->value, 23);
// }
...
BOOST_AUTO_TEST_CASE(partialPlus)
{
    ...
    Parser p;
    {
        ...
        auto c = parsed->eval(env);
        BOOST_CHECK_EQUAL(cast<Integer>(c)->value, 5);
    }
    {
...
BOOST_AUTO_TEST_CASE(firstOrderAsNonInfix)
{
    ...
    }
    {
        ...
        auto c = parsed->eval(env);
        // BOOST_CHECK_EQUAL(cast<Integer>(c)->value, 5);
        auto x = env.getEqual("y")->eval(env);
        BOOST_CHECK_EQUAL(cast<Integer>(x)->value, 0);
    }
}
...
BOOST_AUTO_TEST_CASE(functionOverloading)
{
    ...
    BOOST_CHECK_EQUAL(cast<Integer>(applied0)->value, 1);
    auto applied1 = p.parse("f 2", env)->eval(env);
    BOOST_CHECK(cast<Void>(applied1));
    parsed = p.parse("f 2 = 2", env);
    parsed->eval(env);
    auto applied2 = p.parse("f 1", env)->eval(env);
    BOOST_CHECK_EQUAL(cast<Integer>(applied2)->value, 1);
    auto applied3 = p.parse("f 2", env)->eval(env);
    BOOST_CHECK_EQUAL(cast<Integer>(applied3)->value, 2);
    auto applied4 = p.parse("f 3", env)->eval(env);
    BOOST_CHECK(cast<Void>(applied4));
}
...
BOOST_AUTO_TEST_CASE(unionAsFunctionArgumentSimple)
{
    ...
    parsed->eval(env);
    auto applied0 = p.parse("f 1", env)->eval(env);
    BOOST_CHECK_EQUAL(cast<Integer>(applied0)->value, 3);
    auto applied1 = p.parse("f 2", env)->eval(env);
    BOOST_CHECK_EQUAL(cast<Integer>(applied1)->value, 3);
...
BOOST_AUTO_TEST_CASE(evaluatingInverseFunction)
{
    ...
    }
    {
        ...
        BOOST_CHECK_EQUAL(cast<Integer>(applied)->value, 0);
...
BOOST_AUTO_TEST_CASE(simpleClosure)
{
    ...
    Parser p;
    {
        ...
        auto c = parsed->eval(env);
        BOOST_CHECK_EQUAL(cast<Integer>(c)->value, 3);
    }
    {
...
BOOST_AUTO_TEST_CASE(closureIntersection)
{
   ...
   Parser p;
   {
       ...
       auto c = parsed->eval(env);
       BOOST_CHECK_EQUAL(cast<Integer>(c)->value, 1);
   }
   {
...
//         auto x = env.getEqual("x");
//         BOOST_REQUIRE(checkType<Integer>(x));
//         BOOST_CHECK_EQUAL(cast<Integer>(x)->value, 5);
//     }
//     {
//         Environment env;
//         Parser p;
...
BOOST_AUTO_TEST_CASE(noEnvironmentSharing)
{
    ...
    Parser p;
    {
        ...
        auto y = env.getEqual("y");
        BOOST_REQUIRE(checkType<Integer>(y));
        BOOST_CHECK_EQUAL(cast<Integer>(y)->value, 1);
    }
    {
...
BOOST_AUTO_TEST_CASE(simpleLet)
{
    ...
    BOOST_REQUIRE(checkType<Integer>(x));
    BOOST_CHECK_EQUAL(cast<Integer>(x)->value, 3);
}
